...
?>
	...
	<style type="text/css"> #about-hlink{ color: #FFFFFF !important; } </style>
	...
	<div class="grey-gradiant-half center">
		<div class="inline-block v-padding-2x">
			...
			<img class="float-right v-padding-2x" src="/images/me2.png">
		</div>
	</div>
		...
		<div class="inline-block v-padding-2x" style="background: url('/images/men.png'); background-position: bottom right; background-repeat: no-repeat;">
			<div class=float>
				...
				<div class="description" style="width:700px;font-size:14px;">
					<ul>
						<li>I prefer the red pill</li>
						<li>I firmly believe that we will create time machine and warp drives</li>
						<li>Batman and Superman are my super heroes</li>
						<li>I'm waiting for a Pleiadian encounter</li>
						<li>The world can be a better place</li>
						<li>Love those little minions</li>
						<li>I'm a believer in my own ways</li>
						<li>The matrix trilogy and Inception and my favorite movies</li>
